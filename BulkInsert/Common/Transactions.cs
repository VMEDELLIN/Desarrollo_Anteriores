        ...
        public string FindResponseIssuerById( MySqlDatabase Database )
        {
            ...
            try
            {
                using (conn)
                {
                    ...
                    LogClass.LogInfo("Busqueda Mejorada", "Buscar mensaje de emisor", $"Id {Id}  IssuerId {IssuerId} ShippingKey {ShippingKey}",3);
                    ...
                    LogClass.LogInfo("Busqueda Mejorada", "Buscar mensaje de emisor", $"result {result}",3);
                    reader.Close();
                    reader.Dispose();
                    reader.Close();
                }
