...
namespace GuardianRun
{
    public static class LogClass
    {
        ...
        private static void Info(string[] lines)
        {
            ...
            if (File.Exists(fileName))
            {
                try
                {
                    ...
                    {
                        streamWriter.WriteLine(string.Format("{0:HH:mm:ss}", DateTime.Now) + " " + line);
                    }
        ...
        private static void Info(Object info)
        {
            ...
            if (File.Exists(fileName))
            {
                try
                {
                    ...
                    string val = string.Format("{0:HH:mm:ss}", DateTime.Now) + " " + info.ToString();
            ...
            else
            {
                ...
                try
                {
                    ...
                    String val1 = string.Format("{0:HH:mm:ss}", DateTime.Now) + " " + info.ToString();
        ...
        public static void LogInfo(string id, string location, string info)
        {
            int debug = 0;
